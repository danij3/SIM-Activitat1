...
-- Eliminar taules 
/*DROP TABLE persones PURGE;
DROP TABLE professors PURGE;
DROP TABLE pas_obj PURGE;
DROP TABLE empleats PURGE;
DROP TABLE estudiants PURGE;
DROP TABLE est_grau_obj PURGE;
DROP TABLE est_cicles_obj PURGE;

-- Eliminar types 
DROP TYPE Est_cicles FORCE;
DROP TYPE Est_grau FORCE;
DROP TYPE PAS FORCE;
DROP TYPE Professor FORCE;
DROP TYPE Estudiant FORCE;
