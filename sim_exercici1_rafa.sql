...
-------------------------------------------
-- Eliminar tablas primero (usar PURGE para vaciar papelera)
/*DROP TABLE tab_comanda PURGE;
DROP TABLE tab_client PURGE;
DROP TABLE tab_producte PURGE;

-- Eliminar tipos desde los más específicos hasta el base
DROP TYPE COMANDA FORCE;
DROP TYPE taula_linies FORCE;
DROP TYPE LINIA FORCE;
DROP TYPE CLIENT FORCE;
DROP TYPE vec_telefon FORCE;
DROP TYPE Telefon FORCE;
DROP TYPE PRODUCTE FORCE;*/
